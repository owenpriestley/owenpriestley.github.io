...
[<i class="fa fa-file-pdf-o" aria-hidden="true"></i>  PDF](simpletalk.pdf){: .btn .btn--large}
</div>
...
[<i class="fa fa-file-pdf-o" aria-hidden="true"></i>  PDF](SOC5-Workingwithmigrationscripts.pdf){: .btn .btn--large}
</div>
